    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('testimonio.guardar')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="url_empresa" type="url" class="form-control{{ $errors->has('url_empresa') ? ' is-invalid' : '' }}" name="url_empresa" placeholder="http://" value="{{ old('url_empresa') }}" required autofocus>
